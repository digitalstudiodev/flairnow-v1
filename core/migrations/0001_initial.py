# Generated by Django 3.0.7 on 2020-08-26 18:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sure', models.CharField(choices=[('Y', 'Yes')], default=None, max_length=1000, null=True, verbose_name='Are you sure?')),
                ('internship', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Internship')),
