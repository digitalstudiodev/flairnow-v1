...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0021_auto_20200820_1155'),
    ]

    operations = [
        migrations.AddField(
            model_name='organizationbackground',
            name='industry',
        ...
        migrations.AddField(
            model_name='organizationbackground',
            name='size',
            field=models.IntegerField(default=None, null=True, verbose_name='Number of Individuals'),
        ),
        migrations.AddField(
            model_name='organizationbackground',
            name='type',
            field=models.CharField(choices=[('LLC', 'Limited Liability Company'), ('NPC', 'Non-Profit Corporation'), ('HSS', 'High School'), ('EDU', 'College or University'), ('SDS', 'School District'), ('TWN', 'City or Town'), ('OTH', 'Other')], default=None, max_length=1000, null=True, verbose_name='Organization Type'),
        ),
    ]
