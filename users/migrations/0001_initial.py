    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('phone_number', models.CharField(default='', help_text='Please enter in the following format: 9734568456', max_length=10, null=True, verbose_name='Phone Number')),
                ('primary_address', models.CharField(default='', max_length=1000, null=True, verbose_name='Primary Address')),
                ('zip_code', models.CharField(default='', max_length=1000, null=True, verbose_name='Zip Code')),
                ...
                ('facebook_link', models.CharField(default='', max_length=1000, null=True, verbose_name='Facebook Link')),
                ('linkedin_link', models.CharField(default='', max_length=1000, null=True, verbose_name='LinkedIn Link')),
                ('twitter_link', models.CharField(default='', max_length=1000, null=True, verbose_name='Twitter Link')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('q1', models.TextField(help_text='Max Length (1000 characters)', max_length=1000, verbose_name='Tell us a bit about yourself.')),
                ...
                ('q3', models.TextField(help_text='Max Length (1000 characters)', max_length=1000, verbose_name='What are your strengths?')),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('phone_number', models.CharField(default='', help_text='Please enter in the following format: 9734568456, with no spaces or special characters.', max_length=10, null=True, verbose_name='Phone Number')),
                ('date_of_birth', models.CharField(default='', help_text='Please enter in the following format: MM/DD/YYY or MM-DD-YYY', max_length=10, null=True, verbose_name='Date of Birth')),
                ('primary_address', models.CharField(default='', max_length=1000, null=True, verbose_name='Primary Address')),
                ('zip_code', models.CharField(default='', max_length=1000, null=True, verbose_name='Zip Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.CharField(choices=[('R0', 'American Indian or Alaska Native'), ('R1', 'Asian'), ('R2', 'Black or African American'), ('R3', 'Hispanic or Latino'), ('R4', 'Native Hawaiian or Other Pacific Islander'), ('R5', 'White'), ('P', 'Prefer Not To Say')], default=None, max_length=1000, null=True, verbose_name='Race')),
                ('citizenship', models.CharField(choices=[('C0', 'U.S. Citizen'), ('C1', 'U.S. Permanent Resident'), ('C2', 'DACA'), ('C3', 'TPS'), ('OTH', 'Other'), ('P', 'Prefer Not To Say')], default=None, max_length=1000, null=True, verbose_name='Citizenship')),
                ('household_size', models.CharField(choices=[('HS0', 'Small (Less than 3)'), ('HS1', 'Midsize (3-5)'), ('HS2', 'Large (Over 5)'), ('HS3', 'X-Large (Over 10)'), ('P', 'Prefer Not To Say')], default=None, max_length=1000, null=True, verbose_name='Household Size')),
                ('household_income', models.CharField(choices=[('HI0', 'Less than $10,000'), ('HI1', 'Between $10,000 - $25,000'), ('HI2', 'Between $25,000 - $50,000'), ('HI3', 'Between $50,000 - $100,000'), ('HI4', 'Between $100,000 - $150,000'), ('HI5', 'Between $150,000 - $200,000'), ('HI6', 'Over $200,000'), ('P', 'Prefer Not To Say')], default=None, max_length=1000, null=True, verbose_name='Household Income')),
                ('first_gen', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], default=None, max_length=1000, null=True, verbose_name='Are you the first in your family to go to college?')),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_in_pursuit', models.CharField(choices=[('L0', 'High School Diploma (or Equivalent)'), ('L1', 'Associate Degree'), ('L2', "Bachelor's Degree"), ('L3', "Master's Degree"), ('L4', 'Doctoral Degree'), ('P', 'Prefer Not To Say')], default=None, max_length=1000, null=True, verbose_name='Degree You Are Currently Pursuing')),
